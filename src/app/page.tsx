      ...
      <div className="flex flex-col bg-black text-white min-h-screen">
        <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 relative overflow-hidden py-3 z-10">
          ...
          <div className="relative z-10 w-full max-w-lg mx-auto py-6">
            ...
            {userCount !== null && (
              <div className="relative mt-8 sm:mt-10 bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-100 px-6 sm:px-10 py-6 w-full mx-auto text-center z-20">
